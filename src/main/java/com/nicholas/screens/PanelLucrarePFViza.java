...
public class PanelLucrarePFViza extends JPanel {
	...
	public PanelLucrarePFViza() {
		...
		PanelDatePersoanaFizica.lblLucratorSaesp.setVisible(false);
		PanelDatePersoanaFizica.tfLucratorSAESP.setVisible(false);
		panelDatePersoanaFizica.setBounds(0, 11, 1200, 430);
		...
		PanelDateCererePF.lblLetalaNeletala.setVisible(false);
		PanelDateCererePF.letalaNeletalaComboBox.setVisible(false);
		PanelDateCererePF.lblLungaScurta.setVisible(false);
		PanelDateCererePF.lungaScurtaComboBox.setVisible(false);
		PanelDateCererePF.lblDestinaieArm.setVisible(false);
		PanelDateCererePF.destinatieComboBox.setVisible(false);
		PanelDateCererePF.lblNumarCi_1_1.setVisible(false);
		PanelDateCererePF.regimCerereComboBox.setVisible(false);
