...
public class StringsValue {
	...
	public static String mentiuneAtestat = "atestat pentru exercitarea profesiei de agent de securitate, eliberat de emitentatestat, la data de dataatestat, " +
			"cu seria/nr. serienratestat și ";
	...
	public static ArrayList<String> sexStringsTargets = new ArrayList<>(Arrays.asList
			("domnuldoamna", "domiciliatdomiciliata", "sunumituluisusnumitei", "susnumitulsusnumita", "sanctionatsanctionata", "solicitantuluisolicitantei",
					"numituluinumitei", "solicitantulsolicitanta", "domnuluidoamnei"));
